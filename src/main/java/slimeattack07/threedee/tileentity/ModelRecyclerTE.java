...
public class ModelRecyclerTE extends BlockEntity{
	...
	public ModelRecyclerTE(BlockPos pos, BlockState state) {
		super(TDTileEntityTypes.MODEL_RECYCLER.get(), pos, state);
	}
