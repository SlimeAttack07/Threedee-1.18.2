...
public class ModelAssemblerTE extends BlockEntity {
	public boolean stackmode;
	public int dye_amount;
	public String last_recipe = "";

	public ModelAssemblerTE(BlockPos pos, BlockState state) {
		super(TDTileEntityTypes.MODEL_ASSEMBLER.get(), pos, state);
	}
