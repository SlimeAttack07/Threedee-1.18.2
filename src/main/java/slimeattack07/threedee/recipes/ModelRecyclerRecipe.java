...
public class ModelRecyclerRecipe implements Recipe<RecipeWrapper>{
	...
	public static final ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(Threedee.MOD_ID, "model_recycler");
	
	public ModelRecyclerRecipe(ResourceLocation id, Ingredient input, ItemStack output, ItemStack cor_output, float ticks) {
		ID = id;
		INPUT = input;
		OUTPUT = output;
    ...
    public static class Type implements RecipeType<ModelRecyclerRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "model_recycler";
    }
    
    public static class Serializer implements RecipeSerializer<ModelRecyclerRecipe>{
    	 public static final Serializer INSTANCE = new Serializer();
         public static final ResourceLocation ID = new ResourceLocation(Threedee.MOD_ID,"model_recycler");

    	@Override
    	public ModelRecyclerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
    		try {
	    		...
	    		return new ModelRecyclerRecipe(recipeId, input, output, cor_output, ticks_needed);
    	...
    	@Override
    	public ModelRecyclerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
    	...
    	@Override
    	public void toNetwork(FriendlyByteBuf buffer, ModelRecyclerRecipe recipe) {
