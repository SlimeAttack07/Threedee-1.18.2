...
public class HeadAssemblerRecipe implements Recipe<RecipeWrapper>{
	...
	public static final ResourceLocation RECIPE_TYPE_ID = new ResourceLocation(Threedee.MOD_ID, "head_assembler");
	
	public HeadAssemblerRecipe(ResourceLocation id, Ingredient input, Block block_on_top, boolean is_dye_filler, int amount) {
		ID = id;
		INPUT = input;
    ...
    public static class Type implements RecipeType<HeadAssemblerRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "head_assembler";
    }
    
    public static class Serializer implements RecipeSerializer<HeadAssemblerRecipe>{
    	public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(Threedee.MOD_ID,"head_assembler");
    	...
    	@Override
    	public HeadAssemblerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
    		...
    		return new HeadAssemblerRecipe(recipeId, input, block, is_dye_filler, fill_amount);
    	}

    	@Override
    	public void toNetwork(FriendlyByteBuf buffer, HeadAssemblerRecipe recipe) {
